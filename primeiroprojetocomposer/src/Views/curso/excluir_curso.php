    ...
    <main class="container">
        ...
        <form action="/curso/deletar" method="post">
            ...
            <div class="row">
                ...
                <div class="col-6">
                    <label for="tempo_duracao" class="form-label">Tempo de Duração:</label>
                    <input type="text" disabled name="tempo_duracao" 
                        class="form-control" value="<?= $resultado['tempo_duracao'] ?>">
                </div>
            </div>
            <div class="row">
                <div class="col">
